...
sed "s/\*\*:\*\*:\*\*:\*\*:\*\*:\*\*/$ip_address/g" /usr/aris2/resource/aris_control/ethercat.conf_backup > /etc/ethercat.conf
sed "s/\*\*:\*\*:\*\*:\*\*:\*\*:\*\*/$ip_address/g" /usr/aris2/resource/aris_control/ethercat_backup > /etc/sysconfig/ethercat
